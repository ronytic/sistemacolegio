...
<div class="span12 box">
    <div class="box-header">
        <h2><?php echo $idioma['RegistrarFacturaPersonalizada'] ?> </h2>
    </div>
        ...
        <form action="guardar.php" method="post" id="formulario">
            <table class="table table-bordered inicio">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $idioma['NFactura'] ?>: <br><input type="text" class="derecha NFactura" name="NFactura" value="<?php echo (isset($_GET['f']) && $_GET['f'] == 1) ? $_GET['NFactura'] : $NFactura ?>" required></th>
            ...
            <table class="table table-bordered table-hover table-condensed inicio">
                ...
                <tr id="senal">
                    ...
                    <td class="resaltar der" colspan="4"><?php echo $idioma['TotalDescuento'] ?>: </td>
