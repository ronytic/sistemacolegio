...
<table class="table table-condensed table-bordered table-striped table-hover">
    <thead>
        <tr>
            ...
            <th><?php echo $idioma['NFactura'] ?>
                <hr class="separador">
            </th>
            <th><?php echo $idioma['Nit'] ?>
                <hr class="separador"><?php echo $idioma['Paterno'] ?>
            </th>
            <th><?php echo $idioma['FechaFactura'] ?>
                <hr class="separador"><?php echo $idioma['Materno'] ?>
            </th>
            <th><?php echo $idioma['Monto'] ?>
                <hr class="separador"><?php echo $idioma['Nombres'] ?>
            </th>
            <!--<th>Llave</th>-->
            <th><?php echo $idioma['CodigoGenerado'] ?>
                <hr class="separador"><?php echo $idioma['Curso'] ?>
            </th>
            <th><?php echo $idioma['CodigoCorrecto'] ?>
                <hr class="separador"><?php echo $idioma['Telefono'] ?>
            </th>
    ...
    foreach ($fac as $f) {
        ...
        print_r($NAutorizacion, $NFactura, $Nit, $FechaFactura, $Total, $LlaveDosificacion);
