...
if (isset($_POST)) {
	...
	if (count($curs)) {
		...
		if (count($notas)) {
?><div class="alert alert-error"><strong><?php echo $idioma["NotasCualitativasYaGeneradasParaPeriodo"]; ?></strong>
				<hr />
				<strong><?php echo $idioma["DeseaVolverAGenerar"]; ?> <?php echo $Periodo ?> <?php echo $idioma['Periodo'] ?></strong>
			</div>
