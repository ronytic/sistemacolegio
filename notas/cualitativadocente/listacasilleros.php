...
if (!empty($_POST)) {
	...
	if (is_null($notascuali)) {
?>
		<div class="alert alert-danger">
			<?php echo $idioma['NoSeEncontroMateria']; ?>
		</div>
	<?php
		exit;
	}
	...
	<?php if (empty($CodNotasCualitativa)) {
		echo $idioma['NoSeEncontroMateria'];
		exit;
	} ?>
	...
	<div class="alert alert-info"><?php echo $idioma["PulseBotonParaGuardar"] ?></div>
<?php
}
?>