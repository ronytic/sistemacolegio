...
if (isset($_POST)) {
	...
	$tipo = 1;
	if ($cur['Bimestre']) {
		if (strtotime($FechaActual) >= strtotime($fechaInicioBimestre1) and strtotime($FechaActual) <= strtotime($fechaFinBimestre1)) {
			$tipo = 1;
		}
		if (strtotime($FechaActual) >= strtotime($fechaInicioBimestre2) and strtotime($FechaActual) <= strtotime($fechaFinBimestre2)) {
			$tipo = 2;
		}
		if (strtotime($FechaActual) >= strtotime($fechaInicioBimestre3) and strtotime($FechaActual) <= strtotime($fechaFinBimestre3)) {
			$tipo = 3;
		}
		if (strtotime($FechaActual) >= strtotime($fechaInicioBimestre4) and strtotime($FechaActual) <= strtotime($fechaFinBimestre4)) {
			$tipo = 4;
		}
	} else {
		if (strtotime($FechaActual) >= strtotime($fechaInicioTrimestre1) and strtotime($FechaActual) <= strtotime($fechaFinTrimestre1)) {
			$tipo = 1;
		}
		if (strtotime($FechaActual) >= strtotime($fechaInicioTrimestre2) and strtotime($FechaActual) <= strtotime($fechaFinTrimestre2)) {
			$tipo = 2;
		}
		if (strtotime($FechaActual) >= strtotime($fechaInicioTrimestre3) and strtotime($FechaActual) <= strtotime($fechaFinTrimestre3)) {
			$tipo = 3;
		}
	}
?>
