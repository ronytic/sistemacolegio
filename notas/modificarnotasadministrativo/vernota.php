...
<div class="span12 box">
    <div class="box-header">
        <h2><i class="icon-cog"></i><span class="break"></span><?php echo $idioma['Configuracion'] ?> - <?php echo capitalizar($doc['Paterno'] . " " . $doc['Materno'] . " " . $doc['Nombres']) ?></h2>
    </div>
    <div class="box-content">
        <div class="row-fluid">
                ...
                <div class="box-content">
                    ...
                    <select class="span12" name="Curso">
                        <?php foreach ($docmateriacurso->mostrarDocenteOrdenCurso($CodDocente) as $cur) {
                            ...
                            $c = $c = array_shift($c);
                        ?>
                            <option value="<?php echo $c['CodCurso']; ?>" <?php echo (isset($dmc) && $c['CodCurso'] == $dmc['CodCurso']) ? 'selected="selected"' : '' ?>><?php echo $c['Nombre']; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
                ...
                <div class="box-content">
                    ...
                    <select name="Materia" class="span12">
                        <?php foreach ($docmateriacurso->mostrarDocenteMateria($CodDocente) as $docMat) {
                            ...
                            $m = array_shift($m);
                        ?>
                            <option value="<?php echo $m['CodMateria']; ?>" <?php echo (isset($dmc) && $m['CodMateria'] == $dmc['CodMateria']) ? 'selected="selected"' : '' ?>><?php echo $m['Nombre']; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
                ...
                <div class="box-content">
                    ...
                    <select name="Periodo" class="span12">
                        ...
                        for ($i = 1; $i <= $TotalPeriodo; $i++) { ?>
                            <option value="<?php echo $i; ?>" <?php echo (isset($cas) && $i == $cas['Trimestre']) ? 'selected="selected"' : '' ?>><?php echo $i; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
            <div class="span4">
                <div class="box-header">
                    <h2><?php echo $idioma['Acciones'] ?></h2>
                </div>
                <div class="box-content">
