...
if (!empty($_POST)) {
	...
	<table class="table table-bordered table-striped table-condensed">
		<thead>
			<tr>
				<th colspan="2"><?php echo $idioma['Materia'] ?>:</th>
				<th colspan="6"><?php echo $mat['Nombre'] ?></th>
			</tr>
			<tr>
				<th colspan="2"><?php echo $idioma['Periodo'] ?>:</th>
				<th colspan="2"><?php echo $Periodo ?></th>
				<th><?php echo $idioma['Curso'] ?>:</th>
				<th colspan="3"><?php echo $cur['Nombre'] ?></th>
			</tr>
			<tr>
				<th>N</th>
				...
				<th><?php echo $idioma['Promedio'] ?></th>
				<th><?php echo $idioma['Dps'] ?></th>
				<th><?php echo sacarToolTip($idioma['NotaFinal']) ?></th>
				<th><?php echo $idioma['Anotaciones'] ?></th>
			</tr>
		</thead>
		...
		foreach ($RN as $registroN) {
			...
			$al = array_shift($al);
			if (isset($al['CodAlumno']) && $al['CodAlumno'] != "") {
				$i++;
						...
						<table class="table table-bordered table-hover">
							...
							<?php } else { ?>
								<tr class="alert-danger">
									<td colspan="3"><?php echo $idioma['NoExisteRegistroAgenda'] ?></td>
								</tr>
							<?php } ?>
						</table>
					</td>
