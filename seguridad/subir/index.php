...
$directorioInternet = ($config->mostrarConfig("DirectorioInternet", 1));
?>
<?php include_once($folder . "cabecerahtml.php"); ?>
<script language="javascript" type="text/javascript" src="../../js/seguridad/actualizar.js"></script>
<script language="javascript">
    var UrlInternet = "<?php echo $urlInternet; ?>";
    var Directory = "<?php echo $directorioInternet; ?>";
</script>
...
<div class="span3">
    <div class="box">
        ...
        <div class="box-content">
            <select class="span12" multiple="multiple" size="<?php echo count($tablas) ?>" id="tablas">
                <?php $i = 0;
                foreach ($tablas as $t) {
                    $i++;
                    $t = array_shift($t);
