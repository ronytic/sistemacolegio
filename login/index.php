...
$anunciosLogin = $anuncioslogin->mostrarAnuncios(1);
?>
...
<head>
    ...
    <link href="css/estilo2.css?v3" type="text/css" rel="stylesheet" media="all" />
...
<body>
    ...
    <div id="noticerrar" class="oculto">
        <div class="pull-right"><a href="#" title="Cerrar" class="btn btn-mini" id="cerrarnoti"><i class="icon-remove"></i></a></div>
    </div>
