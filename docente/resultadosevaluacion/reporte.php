...
?>
	<table class="table table-bordered">
		<thead>
			<tr>
				<th><?php echo $idioma['Docente'] ?>: <?php echo capitalizar($doc['Paterno'] . " " . $doc['Materno'] . " " . $doc['Nombres']); ?></th>
			</tr>
		</thead>
		<tr>
			<td><?php echo $idioma['Estadisticas'] ?></td>
		</tr>
	</table>
	...
	?>
		<div class="box-header">
			<h2><?php echo $cur['Nombre'] ?> - <?php echo $mat['Nombre'] ?></h2>
		</div>
		<div class="box-content">
			<?php foreach ($evaluaciondocpreguntas->mostrarTodoRegistro() as $edp) {
				$cant = 0;
				$valorrespuesta = array();
