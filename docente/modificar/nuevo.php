        ...
        <div class="box-content">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td><?php campo("DPAnoTitulacion", "text", isset($doc['DPAnoTitulacion']) ? $doc['DPAnoTitulacion'] : '', "span12", 0, $idioma['IngreseSu'] . $idioma['AñoTitulacion']); ?></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['Titulo'] ?></td>
                    <td><?php campo("DPTitulo", "text", isset($doc['DPTitulo']) ? $doc['DPTitulo'] : '', "span12", 0, $idioma['IngreseSu'] . $idioma['Titulo']); ?></td>
                </tr>
            </table>
        </div>
        <div class="box box-header">
        ...
        <div class="box-content">
            <table class="table table-bordered table-hover">
                <tr>
                    ...
                    <td><?php campo("DTCargo", "text", isset($doc['DTCargo']) ? $doc['DTCargo'] : '', "span12", 0, $idioma['IngreseSu'] . $idioma['Cargo']); ?></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['CargaHoraria'] ?></td>
                    <td><?php campo("DTCargaHoraria", "text", isset($doc['DTCargaHoraria']) ? $doc['DTCargaHoraria'] : '', "span12", 0, $idioma['IngreseSu'] . $idioma['CargaHoraria']); ?></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['Antiguedad'] ?></td>
                    <td><?php campo("DTAntiguedad", "text", isset($doc['DTAntiguedad']) ? $doc['DTAntiguedad'] : '', "span12", 0, $idioma['IngreseSu'] . $idioma['Antiguedad']); ?></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['Categoria'] ?></td>
                    <td><?php campo("DTCategoria", "text", isset($doc['DTCategoria']) ? $doc['DTCategoria'] : '', "span12", 0, $idioma['IngreseSu'] . $idioma['Categoria']); ?></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['Observacion'] ?></td>
                    <td><?php campo("Observacion", "text", isset($doc['Observacion']) ? $doc['Observacion'] : '', "span12", 0, $idioma['IngreseSu'] . $idioma['Observacion']); ?></td>
                </tr>
            </table>
