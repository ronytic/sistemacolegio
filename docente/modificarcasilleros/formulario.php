	...
	<table class="table table-bordered table-hover">
		<thead>
			<tr>
				...
				<th><?php echo $idioma['Periodo'] ?></th>
			</tr>
			<tr>
				<th><?php echo capitalizar($doc['Paterno']) ?> <?php echo capitalizar($doc['Materno']) ?> <?php echo capitalizar($doc['Nombres']) ?></th>
				<th><?php echo $cur['Nombre'] ?></th>
				<th><?php echo $mat['Nombre'] ?></th>
				<th><?php echo $cas['Trimestre'] ?></th>
			</tr>
		</thead>
	</table>
	...
	<form class="formulario" method="post" action="modificar.php">
		...
		<table class="table table-bordered table-hover table-striped">
			<thead>
				<tr>
					<th>N</th>
					<th><?php echo $idioma['NotaMinima'] ?></th>
					<th><?php echo $idioma['NotaTope'] ?></th>
					<th><?php echo $idioma['NombreCasillero'] ?></th>
				</tr>
			</thead>
