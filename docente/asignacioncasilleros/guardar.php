...
if (!empty($_POST)) {
	...
	$ma = $materias->mostrarMateria($docmateriacurso['CodMateria']);
	$ma = array_shift($ma);
...
?>
	...
	<table class="table table-striped table-bordered table-hover">
		...
		<tr>
			<td><?php echo $idioma["Materia"]; ?>:</td>
			<td><?php echo $ma['Nombre'] ?></td>
		</tr>
		<tr>
			<td><?php echo $idioma["Docente"]; ?>:</td>
			<td><?php echo ucwords($doc['Paterno']) ?> <?php echo ucwords($doc['Materno']) ?> <?php echo ucwords($doc['Nombres']) ?></td>
		</tr>
		<tr>
			<td><?php echo $idioma["Casilleros"]; ?></td>
			<td><?php echo $Casillas ?></td>
		</tr>
		<tr>
			<td><?php echo $cur['Bimestre'] ? $idioma['Bimestre'] : $idioma["Trimestre"]; ?></td>
			<td><?php echo $Periodo ?></td>
		</tr>
		<tr>
			<td><?php echo $idioma["NotaTopeCasilleros"]; ?>:</td>
			<td><?php echo $cur['NotaTope'] ?></td>
		</tr>
		<tr>
			<td><?php echo $idioma["Dps"]; ?>:</td>
			<td><?php echo $Dps ? $idioma['Si'] : $idioma['No']; ?></td>
		</tr>
	</table>
