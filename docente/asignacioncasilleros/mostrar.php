			...
			<div id="collapse<?php echo $j ?>" class="accordion-body collapse <?php echo $j == $Periodo ? 'in' : ''; ?>">
				<div class="accordion-inner">
					...
					<table class="table table-bordered table-striped table-hover table-condensed">
						<thead>
							<tr>
								<th colspan="3"><?php echo $idioma['Docente'] ?>:</th>
								<th colspan="4"><?php echo capitalizar($doc['Paterno']) ?> <?php echo capitalizar($doc['Materno']) ?> <?php echo capitalizar($doc['Nombres']) ?></th>
							</tr>
							<tr>
								<th colspan="3"><?php echo $idioma['Periodo'] ?>:</th>
								<th colspan="4"><?php echo $j ?></th>
							</tr>
							<tr>
								<th>N</th>
								...
								<th title="<?php echo $idioma['Casillas'] ?>"><?php echo recortarTexto($idioma['Casillas'], 3, "") ?></th>
