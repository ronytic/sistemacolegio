...
?>
    <div class="box-header">
        <h2><i class="icon-user"></i><span class="break"></span><?php echo $idioma['DatosAlumno'] ?></h2>
    </div>
    <div class="box-content">
        ...
        <table class="table table-bordered table-hover table-striped">
            <tr>
                <td class="resaltar" colspan="2"><?php echo $idioma['DatosAlumno'] ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo capitalizar($al['Sexo'] ? $idioma['Masculino'] : $idioma['Femenino']) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo capitalizar($al['Numero']) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="resaltar" colspan="2">
                    <hr />
                </td>
            </tr>
            <tr>
                <td class="resaltar" colspan="2"><?php echo $idioma['DatosAcademicos'] ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="resaltar" colspan="2"><?php echo $idioma['DatosPadreFamilia'] ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="resaltar" colspan="2"><?php echo $idioma['DatosFactura'] ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="resaltar" colspan="2"><?php echo $idioma['Documentos'] ?></td>
            </tr>
            <tr>
