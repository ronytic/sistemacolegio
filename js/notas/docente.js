...
function evaluarNota(data) {
	...
	if (data.Bimestre == 1 && data.TipoNota == "avanzado") {
	...
	} else if (data.Bimestre == 0 && data.TipoNota == "avanzado") {
		$('.al_' + data.CodAlumno + '_2').val(data.PD1);
		$('.al_' + data.CodAlumno + '_7').val(data.PD2);
		$('.al_' + data.CodAlumno + '_12').val(data.PD3);
		$('.al_' + data.CodAlumno + '_14').val(data.PD4);
		$('.al_' + data.CodAlumno + '_16').val(data.PD5);
	}
