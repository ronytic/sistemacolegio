...
<div class="span3">
    <div class="box">
        ...
        <div class="box-content">
            ...
            <select class="span12" id="selectcurso" data-placeholder="<?php echo $idioma['BuscarCursoPor'] ?>">
                <?php
                $i = 0;
                foreach ($curso->mostrar() as $cu) {
                    $i++;
                ?>
                    <option value="<?php echo $cu['CodCurso']; ?>" <?php echo $i == 1 || (isset($CodCurso) && $CodCurso == $cu['CodCurso']) ? 'selected="selected"' : ''; ?> rel="<?php echo $cu['caArea'] ?>">
                        <?php echo $cu['Nombre']; ?>
                    </option>
                <?php
                }
    ...
    <div class="box">
        <div class="box-header">
            <h2><?php if (isset($icono1) && $icono1 != "") { ?><i class="<?php echo $icono1; ?>"></i><span class="break"></span><?php } ?> <?php echo $idioma[$subtitulo1]; ?></h2>
        </div>
...
<div class="span9">
    <div class="box">
        <div class="box-header">
            <h2><?php if (isset($icono2) && $icono2 != "") { ?><i class="<?php echo $icono2; ?>"></i><span class="break"></span><?php } ?> <?php echo $idioma[$subtitulo2]; ?></h2>
        </div>
