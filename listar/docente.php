...
$CodDocente = isset($_GET['CodDocente']) ? $_GET['CodDocente'] : '';
...
<div class="span3">
	<div class="box">
		<div class="box-header">
			<h2><i class="icon-user"></i><span class="break"></span><?php echo $idioma['Docente'] ?></h2>
		</div>
		<div class="box-content">
			...
			<select name="docente" id="docente" class="span12">
				...
				?>
					<option value="<?php echo $doc['CodDocente']; ?>" <?php echo $doc['CodDocente'] == $CodDocente ? 'selected="selected"' : ''; ?>><?php echo $doc['Paterno']; ?> <?php echo $doc['Materno']; ?> <?php echo $doc['Nombres']; ?></option>
				<?php
				}
				?>
			</select>
