				...
				<div class="btn-group pull-right">
					...
					<?php foreach ($menu->mostrar($Nivel, "Superior") as $m) { ?>
						<a class="btn" href="<?php echo $folder ?><?php echo $m['Url'] ?>">
							...
							<span class="hidden-phone hidden-tablet"> <?php echo $idioma[$m['Nombre']] ?></span>
							<span class="label label-<?php echo $m['Nombre'] == 'MisActividades' ? "warning" : "success"; ?> hidden-phone">
								<?php if ($m['Nombre'] == "MisActividades") {
