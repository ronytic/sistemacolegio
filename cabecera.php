		...
		<div class="navbar">
			<div class="navbar-inner">
				<div class="container-fluid">
					<a class="brand" href="<?php echo $folder ?>"> <img alt="<?php echo $Titulo ?>" src="<?php echo $folder; ?>imagenes/logos/<?php echo $LogoInicio; ?>" width="50" height="50" style="width:50" class="logo" />

						<?php echo $Titulo ?> <span class="pequeno hidden-phone hidden-tablet"><?php echo $Gestion ?> - <?php echo $VersionSistema ?></span></a>
					...
					<div class="btn-group pull-right">
						...
						<?php foreach ($menu->mostrar($Nivel, "Superior") as $m) { ?>
							<a class="btn" href="<?php echo $folder ?><?php echo $m['Url'] ?>">
								<i class="<?php echo $m['Imagen'] ?>"></i><span class="hidden-phone hidden-tablet"> <?php echo $idioma[$m['Nombre']] ?></span> <span class="label label-<?php echo $m['Nombre'] == 'MisActividades' ? "warning" : "success"; ?> hidden-phone"><?php if ($m['Nombre'] == "MisActividades") {
																																																																						echo $cantagendaactividades['Cantidad'];
																																																																					} else {
																																																																						echo "0";
																																																																					} ?></span>
							</a>
									...
									<?php
										...
										<ul class="oculto submenu">
											<?php
												...
												<li class="<?php if ($urlSubMenu == $sm['Url']) {
																			$textosubmenu = $idioma[$sm['Nombre']];
																			echo 'selecciona';
																		} ?>">
