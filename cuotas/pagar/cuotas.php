        ...
        ?>
            <tr id="tr<?php echo $cuotas['CodCuota'] ?>" class="contenido <?php echo $cuotas['Cancelado'] ? 'success' : ''; ?>">
                ...
                <td>
                    ...
                    <label class="msg hidden-phone hidden-tablet" for="c<?php echo $cuotas['CodCuota'] ?>"><?php echo $cuotas['Cancelado'] ? "Cancelado" : "Pendiente"; ?></label>
                </td>
                ...
                <td><input type="text" value="<?php if ($cuotas['Cancelado']) echo date("d-m-Y", strtotime($cuotas['Fecha']));
                                                else echo date("d-m-Y"); ?>" size="5" id="fe<?php echo $cuotas['CodCuota']; ?>" / class="ku fechass input-small" rel="<?php echo $cuotas['CodCuota']; ?>"></td>
            </tr>
        <?php
        } ?>
    </table>
