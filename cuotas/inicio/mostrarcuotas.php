...
?>
		...
		<table class="table table-bordered table-striped table-hover inicio">
			<thead>
				<tr>
					<th colspan="5" class="der"><?php echo $idioma['Total'] ?> <?php echo $idioma['Del'] ?> <?php echo $idioma['Dia'] ?> <?php echo $idioma['Recaudado'] ?>: </th>
					<th colspan="2" class="der"><?php echo $MontoTotal ?></th>
				</tr>
				<tr>
					<th>N</th>
