...
$idioma['NoDatos'] = "Por favor introduzca TODOS los DATOS.";
...
$idioma['TituloSistema'] = "Sistema Académico Administrativo para Unidades Educativas";
...
$idioma['NRegistrosEnEspera'] = "Registros en Espera";
...
$idioma['NAsignacionAsesorCurso'] = 'Asignación Asesor a Curso';
//Generales
...
$idioma['ManejarRude'] = "Manejar Rude";
$idioma['CursoAnterior'] = "Curso Anterior";
...
$idioma['Enero'] = "Enero";
$idioma['Febrero'] = "Febrero";
$idioma['Marzo'] = "Marzo";
$idioma['Abril'] = "Abril";
$idioma['Mayo'] = "Mayo";
$idioma['Junio'] = "Junio";
$idioma['Julio'] = "Julio";
$idioma['Agosto'] = "Agosto";
$idioma['Septiembre'] = "Septiembre";
$idioma['Octubre'] = "Octubre";
$idioma['Noviembre'] = "Noviembre";
$idioma['Diciembre'] = "Diciembre";
...
$idioma['Colegio'] = "Unidad Educativa";
$idioma['Rude'] = "Rude";
...
$idioma['PaginaColegio'] = "Página de la Unidad Educativa";
...
$idioma['MontoCancelado'] = "Monto Cancelado";
$idioma['TotalAdeudado'] = "Total Adeudado";
$idioma['TotalCancelado'] = "Total Cancelado";
$idioma['Adeudado'] = "Adeudado";
...
$idioma['RegistroEnEspera'] = "Registros en Espera";
//Rude
...
$idioma['TodoColegio'] = "Toda la Unidad Educativa";
//Cuotas
...
$idioma['ConLosSiguientesDatos'] = "Con los siguientes datos";
$idioma['Casilleros'] = "Casilleros";
$idioma['GuardarConfiguracionCasilleros'] = "¿Esta seguro de guardar esta configuración del Docente, Curso, Materia y el Tipo de Nota?";
$idioma['NoSePodraModificar'] = "NO SE PODRÁ CAMBIAR ESTA CONFIGURACIÓN POSTERIORMENTE";
$idioma['DebeSeleccionarCursoMateria'] = "Debe Seleccionar Curso y Materia";
$idioma['TipoRegistroNotas'] = "Tipo de Registro de Notas";
...
$idioma['NotaAvanzado'] = "Si usted selecciona avanzado, el sistema será el encargado internamente de asignar  el número de casilleros y la metodología de calificación de acuerdo al cuaderno pedagógico del registro de notas";
...
$idioma['AsignacionDocenteErronea'] = "Si la <b>'Asignación Materias'</b> de Docente es errónea corríjala en <b>'Asignación de Materia'</b>";
...
$idioma['Estadistica'] = "Estadística";
...
$idioma['TipoDocumento'] = "Tipo de Documento";
$idioma['NumeroDocumento'] = "Número de Documento";
$idioma['CorreoElectronico'] = "Correo Electrónico";
$idioma['EnlaceSIN'] = "Enlace en Impuestos Nacionales";
$idioma['FacturaRegistradaCorrectamente'] = "Factura Registrada Correctamente";
//Seguridad
...
$idioma['VisibleRegistroNotaHabilitado'] = "¿Visible Registro de Notas Habilitado?";
$idioma['VisibleRegistroNotaHabilitadoE'] = "Habilita la visualización del Registro de Notas de los Docentes mediante internet";
$idioma['VisibleNotasPPFFAlumno'] = "¿Visible Notas para PPFF Alumno?";
$idioma['VisibleNotasPPFFAlumnoE'] = "Habilita la visualización de las Notas para los Padres de Familia y alumnos";
$idioma['VisibleNotasPPFFAlumnoRestringido'] = "Se ha restringido la visualización de las Notas para los Padres de Familia y alumnos";
...
$idioma['NReinscripcionAlumno'] = "Reinscripción de Alumnos";
...
$idioma['NuevoSistemaFacturacion'] = "Sistema Facturación Virtual con el Código QR";
$idioma['SistemaFacturacionElectronica'] = "Nuevo Sistema Facturación Electrónica";
$idioma['SistemaFacturacionVirtual'] = "Sistema Facturación Virtual";
$idioma['Sucursal'] = "Sucursal";
$idioma['SucursalT'] = "Seleccione la Sucursal por defecto";
$idioma['PuntoDeVenta'] = "Punto de Venta";
$idioma['PuntoDeVentaT'] = "Seleccione el Punto de Venta por defecto";
$idioma['MetodoDePago'] = "Método de Pago";
$idioma['MetodoDePagoT'] = "Seleccione el Método de Pago por defecto";
$idioma['NumeroTarjeta'] = "Número de Tarjeta";
$idioma['MontoGiftCard'] = "Monto Gift Card";
$idioma['NDocumento'] = "NºDocumento";
$idioma['TipoDeMoneda'] = "Tipo de Moneda";
$idioma['TipoDeMonedaT'] = "Seleccione el Tipo de Moneda por defecto";
$idioma['SFEUrl'] = "Url del SFE";
$idioma['SFEUrlT'] = "Introduzca la Url del Sistema de Facturación Electrónica";
$idioma['SFEUsuario'] = "Usuario del SFE";
$idioma['SFEUsuarioT'] = "Introduzca el Usuario del Sistema de Facturación Electrónica para obterner el Token";
$idioma['SFEContrasena'] = "Contraseña del SFE";
$idioma['SFEContrasenaT'] = "Introduzca la Contraseña del Sistema de Facturación Electrónica para obterner el Token";
$idioma['SFEValidezToken'] = "Validez del Token";
$idioma['SFEValidezTokenT'] = "Validez del Token del Sistema de Facturación Electrónica";
$idioma['SFESistema'] = "Sistema del SFE";
$idioma['SFESistemaT'] = "Seleccione el Sistema del Sistema de Facturación Electrónica";
$idioma['SFEDetalleFactura'] = "Detalle de la Factura";
$idioma['SFEUnidadMedidaMensualidad'] = "Unidad de Medida de la Mensualidad";
$idioma['SFEUnidadMedidaMensualidadT'] = "Seleccione la Unidad de Medida de la Mensualidad";
$idioma['SFECodigoProductoSIN'] = "Código Producto SIN";
$idioma['SFECodigoProductoSINT'] = "Seleccione el Código Producto SIN equivalente a la Mensualidad";
$idioma['SFECodigoProductoInterno'] = "Código Producto Interno";
$idioma['SFECodigoProductoInternoT'] = "Introduzca el Código Producto Interno de la Mensualidad";
$idioma['SFEActividades'] = "Actividad económica de la Unidad Educativa";
$idioma['SFEActividadesT'] = "Seleccione la Actividad económica de la Unidad Educativa";
$idioma['NitEmisor'] = "Nit Emisor";
$idioma['NitEmisorT'] = "Introduzca el Nit del Emisor de la Factura";
$idioma['RazonSocialEmisor'] = "Razón Social del Emisor";
$idioma['RazonSocialEmisorT'] = "Introduzca la Razón Social del Emisor";
$idioma['ActividadEconomica'] = "Actividad Económica";
$idioma['ActividadEconomicaT'] = "Introduzca la descripción de la Actividad Económica";
$idioma['LeyendaPiePagina'] = "Leyenda Pie Página";
$idioma['LeyendaPiePaginaT'] = "Introduzca la leyenda del Pie de Página de la Factura";
//Inicio
...
$idioma['NoCuentaConAnotacionesALaFecha'] = "No existen registros en la agenda a la Fecha";
$idioma['NoTieneTareasPendientes'] = "No tiene tareas pendientes";
$idioma['NoTieneTareasRevisadas'] = "No tiene tareas revisadas";
$idioma['Notas'] = "Notas";
$idioma['FechaPresentacion'] = "Fecha de Presentación";
$idioma['OrdenObservaciones'] = "Las observaciones están ordenadas del último registro al primero.";
$idioma['PromedioAnual'] = "Promedio Anual";
$idioma['Reforzamiento'] = "Reforzamiento";
$idioma['PromedioFinal'] = "Promedio Final";
$idioma['RedirigirAlumnoVersionResumida'] = "Redirigir al Alumno a la Versión Resumida";
$idioma['RedirigirAlumnoVersionResumidaDetalle'] = "Esta opción sirve para redigir al Alumno a la versión resumida sin mostrar los menús de la izquierda";
//SMS
...
$idioma['NadaPuerto'] = "Introduzca el valor de '0' si no se encuentra conectado el Dispositivo USB, se recomienda el uso de los Puertos del 1 al 9, si su dispositivo se encuentra en otro número de puerto, cambielo a un puerto adecuado";
...
$idioma['InscribirHermano'] = "Inscribir Hermano(a)";
...
$idioma['DescargarNotasInternet'] = "Descargar Notas de Internet";
$idioma['MensajesAccesoSistema'] = "Comunicados en Acceso al Sistema";
...
$idioma['AsignarAsesor'] = 'Asignación Asesor a Curso';
//Factura
...
$idioma['BoletinNotasMediaCarta'] = 'Boletín de Notas Medía Carta';
$idioma['BoletinNotasMediaCartaE'] = 'El boletín de notas, si se encuentra configurado en SI tamaño carta, se generará con bordes definidos, si se encuentra configurado en NO, se generará el boletín para una hoja membretada';
$idioma['ReporteGeneralAgenda'] = 'Reporte General de la Agenda';
$idioma['SeleccionarCurso'] = 'Seleccionar Curso';
$idioma['EliminarAsignacionAsesor'] = "¿Esta Seguro de Eliminar este Curso?";
$idioma['YaAsignadoCurso'] = "Ya fué Asignado el Curso";

$idioma['RegistrarEventoSignificativo'] = "Registrar Evento Significativo";
$idioma['EventoSignificativo'] = "Evento Significativo";
$idioma['EventosSignificativos'] = "Eventos Significativos";
$idioma['EventoSignificativoRegistradoCorrectamente'] = "Evento Significativo Registrado Correctamente";
$idioma['ErrorAlRegistrarEventoSignificativo'] = "Error al Registrar el Evento Significativo";
$idioma['NoHayEventosSignificativos'] = "No hay Eventos Significativos Registrados";
$idioma['EstadoFactura'] = "Estado de la Factura";
$idioma['FacturasEmitidas'] = "Facturas Emitidas";
$idioma['EnviarPaquete'] = "Enviar Paquete";
$idioma['PaqueteEnviadoCorrectamente'] = "Paquete enviado correctamente";
$idioma['ErrorEnviarPaquete'] = "Error al enviar paquete";
$idioma['FinalizarEvento'] = "Finalizar Evento";
$idioma['EventoFinalizadoCorrectamente'] = "Evento Finalizado Correctamente";
$idioma['ErrorFinalizarEvento'] = "Error al finalizar el Evento";
$idioma['CancelarEvento'] = "Cancelar Evento";
$idioma['EventoCanceladoCorrectamente'] = "Evento Cancelado Correctamente";
$idioma['ErrorCancelarEvento'] = "Error al cancelar el Evento";
$idioma['ReenviarCorreo'] = "Reenviar Correo";
$idioma['SeguroReenviarCorreo'] = "¿Esta seguro de reenviar el correo Electronico?";
$idioma['CorreoEnviadoCorrectamente'] = "Correo Enviado Correctamente";
...
$idioma['NoUsarFacturacion'] = "No Usar Facturación";
