    ...
    <div id="noticerrar" class="oculto">
    	<div class="pull-right"><a href="#" title="<?php echo $idioma['Cerrar'] ?>" class="btn btn-mini" id="cerrarnoti"><i class="icon-remove"></i></a></div>
    </div>
    <div id="cuerponotificacion" class="oculto">
		...
		if ($notitotal) {
		?>
    		<ul class="unstyled listanotificacion">
    			<?php
				foreach ($noti1 as $no1) {
				?>
    				<li class="pequeno"><span class="label label-important"><i class="icon-bullhorn"></i></span> <?php echo $no1['Mensaje'] ?></li>
    			<?php
				}
				foreach ($noti2 as $no2) {
				?>
    				<li class="pequeno"><span class="label label-warning"><i class="icon-bell"></i></span> <?php echo $no2['Mensaje'] ?></li>
    			<?php
				}
				foreach ($noti3 as $no3) {
				?><li class="pequeno"><span class="label label-success"><i class="icon-bell"></i></span> <?php echo $no3['Mensaje'] ?></li>
    			<?php
				}
				?>
    		</ul>
...
/*
	...
	*/ ?>
    <script language="javascript">
    	...
    	var MensajeCargando = "<?php echo $idioma['Cargando'] ?>";
