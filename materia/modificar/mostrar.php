    ...
    <table class="table table-bordered table-striped table-hover table-condensed">
        <thead>
            <tr>
                ...
                <th><?php echo $idioma['Abreviado'] ?></th>
                <th><?php echo $idioma['NombreAlterno'] ?>1</th>
                <th><?php echo $idioma['NombreAlterno'] ?>2</th>
                <th><?php echo $idioma['PromedioCiencias'] ?></th>
                <th><?php echo $idioma['Valido'] ?></th>
                <th></th>
            </tr>
        </thead>
        <?php
...
<?php
    ...
    <div class="alert alert-error"><?php echo $idioma['NoExisteMateriasRegistrados'] ?></div>
<?php
}
?>