...
<form action="guardar.php" method="post">
    <div class="span6 box">
        <div class="box-header">
            <h2><?php echo $idioma['Periodos'] ?> - <?php echo $idioma['Trimestre'] ?> - <?php echo $idioma['Bimestre'] ?><a name="periodos"></a></h2>
        </div>
        <div class="box-content">
            <table class="table table-hover table-bordered table-condensed">
                <tr>
                    <td><?php echo $idioma['TotalPeriodo'] ?><div class="pequeno"><?php echo $idioma['TotalPeriodoE'] ?></div>
                    </td>
                    <td width="150"><input type="number" class="span6 der" name="TotalPeriodo" value="<?php echo (dato("TotalPeriodo")) ?>" readonly min="1"></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['PeriodoActual'] ?><div class="pequeno"><?php echo $idioma['PeriodoActualE'] ?></div>
                    </td>
                ...
                <tr>
                    <td><?php echo $idioma['PeriodoActualBimestre'] ?><div class="pequeno"><?php echo $idioma['PeriodoActualBimestreE'] ?></div>
                    </td>
                ...
                <tr>
                    <td><?php echo $idioma['PeriodoActualTrimestre'] ?><div class="pequeno"><?php echo $idioma['PeriodoActualTrimestreE'] ?></div>
                    </td>
        ...
        <div class="box-header">
            <h2><?php echo $idioma['Cuotas'] ?><a name="cuotas"></a></h2>
        </div>
        <div class="box-content">
        ...
        <div class="box-header">
            <h2><?php echo $idioma['Agenda'] ?><a name="agenda"></a></h2>
        </div>
        <div class="box-content">
            <table class="table table-bordered table-hover">
                <tr>
    ...
    <div class="span6 box">
        <div class="box-header">
            <h2><?php echo $idioma['Notas'] ?><a name="notas"></a></h2>
        </div>
        <div class="box-content">
            <table class="table table-bordered table-hover">
                <tr>
                    <td><?php echo $idioma['RegistroNotaHabilitado'] ?><div class="pequeno"><?php echo $idioma['RegistroNotaHabilitadoE'] ?></div>
                    </td>
                ...
                <tr>
                    <td><?php echo $idioma['PeriodoNotaHabilitadoBimestre'] ?><div class="pequeno"><?php echo $idioma['PeriodoNotaHabilitadoE'] ?></div>
                    </td>
                ...
                <tr>
                    <td><?php echo $idioma['BoletinNotasMediaCarta'] ?><div class="pequeno"><?php echo $idioma['BoletinNotasMediaCartaE'] ?></div>
                    </td>
                    <td width="20%"><select class="span12" name="BoletinMediaCarta">
                            <option value="0" <?php echo (dato("BoletinMediaCarta")) == 0 ? 'selected' : '' ?>><?php echo $idioma['No'] ?></option>
                            <option value="1" <?php echo (dato("BoletinMediaCarta")) == 1 ? 'selected' : '' ?>><?php echo $idioma['Si'] ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
        ...
        <div class="box-header">
            <h2><?php echo $idioma['NotasCualitativas'] ?><a name="notascualitativas"></a></h2>
        </div>
        <div class="box-content">
            <table class="table table-bordered table-hover">
                <tr>
                    <td colspan="2" class="resaltar"><?php echo $idioma['Bimestre'] ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" class="resaltar"><?php echo $idioma['Trimestre'] ?></td>
                </tr>
                <tr>
        ...
        <div class="box-header">
            <h2><?php echo $idioma['DatosInstitucion'] ?><a name="datosinstitucion"></a></h2>
        </div>
        <div class="box-content">
            <table class="table table-bordered table-hover">
                <tr>
                ...
                <tr>
                    <td width="50%"><?php echo $idioma['TituloSistemaA'] ?><div class="pequeno"><?php echo $idioma['TituloSistemaE'] ?></div>
                    </td>
                ...
                <tr>
                    <td><?php echo $idioma['Lema'] ?><div class="pequeno"><?php echo $idioma['LemaE'] ?></div>
                    </td>
        ...
        <?php if ($_SESSION['Nivel'] == 1) : ?>
            ...
            <div class="box-content">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        <td><?php echo $idioma['DirectorioInternet'] ?><div class="pequeno"><?php echo $idioma['DirectorioInternetE'] ?></div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><textarea class="span12" name="CodigoSeguimientoNotasDocente" rows="10"><?php echo (dato("CodigoSeguimientoNotasDocente", true)) ?></textarea></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><textarea class="span12" name="CodigoSeguimientoSistema" rows="10"><?php echo (dato("CodigoSeguimientoSistema", true)) ?></textarea></td>
                    </tr>
                    <tr>
                        <td><?php echo $idioma['CodigoAdicionalSistemaLogin'] ?></td>
                        <td><textarea class="span12" name="CodigoAdicionalSistemaLogin" rows="10"><?php echo (dato("CodigoAdicionalSistemaLogin", true)) ?></textarea></td>
                    </tr>
                    <tr>
                        <td class="centrar" colspan="2"><input type="submit" class="btn btn-success" value="<?php echo $idioma['Guardar'] ?>"></td>
                    </tr>
