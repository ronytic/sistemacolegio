	...
	<table class="table table-bordered table-striped table-hover table-condensed">
		<thead>
			<tr>
				...
				<th><?php echo $idioma['TipoObservacion'] ?></th>
				<th><?php echo $idioma['MostrarDocente'] ?></th>
				<th><?php echo $idioma['Orden'] ?></th>
				<th></th>
			</tr>
		</thead>
		<?php
...
<?php
	...
	<div class="alert alert-error"><?php echo $idioma['NoExisteObservacionesRegistrados'] ?></div>
<?php
}
?>