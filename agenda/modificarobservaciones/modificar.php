        ...
        <table class="table table-bordered table-striped">
            <tr>
                <td><?php echo $idioma['Nombre'] ?><br>
                    <input type="text" value="<?php echo $obs['Nombre'] ?>" name="Nombre" class="span12" placeholder="">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><?php echo $idioma['Orden'] ?><br>
                    <input type="text" value="<?php echo $obs['Posicion'] ?>" name="Posicion" class="span12" placeholder="">
                </td>
            </tr>
            <tr>
