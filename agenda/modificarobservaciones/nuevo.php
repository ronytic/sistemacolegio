        ...
        <table class="table table-bordered table-striped">
            <tr>
                <td><?php echo $idioma['Nombre'] ?><br>
                    <input type="text" value="<?php echo isset($obs['Nombre']) ? $obs['Nombre'] : '' ?>" name="Nombre" class="span12" placeholder="">
                </td>
            </tr>
            <tr>
                <td><?php echo $idioma['TipoObservacion'] ?><br>
                    <?php campo("NivelObservacion", "select", $tipo, "span12", 1, "", 0, "", isset($obs['NivelObservacion']) ? $obs['NivelObservacion'] : '') ?>
                    <small><?php echo $idioma['NotaTipoObservacion'] ?></small>
                </td>
            </tr>
            <tr>
                <td><?php echo $idioma['MostrarDocente'] ?><br>
                    <?php campo("Docente", "select", $sino, "span12", 1, "", 0, "", isset($obs['Docente']) ? $obs['Docente'] : '') ?>
                    <small><?php echo $idioma['NotaMostrarDocente'] ?></small>
                </td>
            </tr>
            <tr>
                <td><?php echo $idioma['Orden'] ?><br>
                    <input type="text" value="<?php echo isset($obs['Posicion']) ? $obs['Posicion'] : '' ?>" name="Posicion" class="span12" placeholder="">
                </td>
            </tr>
            <tr>
