	...
	<table class="table table-hover table-bordered table-striped">
		<thead>
			<tr>
				...
				<th colspan="1"><?php echo $ma['Nombre'] ?></th>
				<th colspan="2"><?php echo $idioma['FechaHoy'] ?></th>
			</tr>
			<tr>
				<th colspan="2"><?php echo $idioma['Curso'] ?>:</th>
				<th colspan="1"><?php echo $cu['Nombre'] ?></th>
				<th colspan="2"><?php echo date("d-m-Y") ?></th>
			</tr>
			<tr>
				<th style="max-width:15px;width:15px;">N</th>
				<th><?php echo $idioma['Tarea'] ?></th>
				<th><?php echo $idioma['Descripcion'] ?></th>
				<th style="max-width:75px;width:75px;"><?php echo $idioma['Fecha'] ?></th>
				<th></th>
			</tr>
		</thead>
		<?php
		...
		?>
			...
			?><tr>
				<td colspan="5"><strong><?php echo $idioma['NoHayTareasRegistradas'] ?></strong></td>
			</tr><?php
				}
					?>
	</table>
