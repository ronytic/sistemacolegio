        ...
        <div class="box-content">
            <table class="table table-hover table-striped">
                ...
                <tr>
                    ...
                    <td>::</td>
                    <td><input type="text" name="nombres" value="<?php echo mayuscula($al['Nombres']); ?>" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>::</td>
                    <td><input name="numeroDoc" type="text" id="numeroDoc" value="<?php echo mayuscula($al['Ci']); ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['FechaNacimiento'] ?></td>
                    <td>::</td>
                    <td><input name="fechaNac" type="text" id="fechaNac" value="<?php echo fecha2Str($al['FechaNac']); ?>" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>::</td>
                    <td><input type="text" name="paisNacA" value="<?php echo $alu['PaisN'] != "" ? mayuscula($alu['PaisN']) : mayuscula("BOLIVIA"); ?>" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>::</td>
                    <td><input type="text" name="provinciaNacA" value="<?php echo $alu['ProvinciaN'] != "" ? mayuscula($alu['ProvinciaN']) : mayuscula("MURILLO"); ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['Localidad'] ?></td>
                    <td>::</td>
                    <td><input type="text" name="localidadNacA" value="<?php echo $alu['LocalidadN'] != "" ? mayuscula($alu['LocalidadN']) : mayuscula("NUESTRA SEÑORA DE LA PAZ"); ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['OficialiaN'] ?></td>
                    <td>::</td>
                    <td><input type="text" name="oficialiaA" value="<?php echo mayuscula($alu['CertOfi']); ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['LibroN'] ?></td>
                    <td>::</td>
                    <td><input type="text" name="libroA" value="<?php echo mayuscula($alu['CertLibro']); ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['PartidaN'] ?></td>
                    <td>::</td>
                    <td><input type="text" name="partidaA" value="<?php echo mayuscula($alu['CertPartida']); ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['FolioN'] ?></td>
                    <td>::</td>
                    <td><input type="text" name="folioA" value="<?php echo mayuscula($alu['CertFolio']); ?>" /></td>
                </tr>
            </table>
        </div>
        ...
        <div class="box-content">
            <table class="table table-hover table-striped">
                ...
                <tr>
                    ...
                    <td>::</td>
                    <td><input type="text" name="codigoSIEA" value="<?php echo mayuscula($alu['CodigoSie']); ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['NombreColegioAnterior'] ?></td>
                    <td>::</td>
                    <td><input type="text" name="unidadEducativaA" value="<?php echo mayuscula($alu['NombreUnidad']); ?>" /></td>
                </tr>
            </table>
        </div>
        ...
        <div class="box-content">
            <table class="table table-hover table-striped">
                <tr>
                    ...
                    <td>::</td>
                    <td><input type="text" name="provinciaA" value="<?php echo $alu['ProvinciaE'] != "" ? mayuscula($alu['ProvinciaE']) : mayuscula("MURILLO"); ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['Seccion']; ?></td>
                    <td>::</td>
                    <td><input type="text" name="seccionA" value="<?php echo $alu['MunicipioE'] != "" ? mayuscula($alu['MunicipioE']) : mayuscula("CUARTA SECCIÓN"); ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['Localidad']; ?></td>
                    <td>::</td>
                    <td><input type="text" name="localidadA" value="<?php echo $alu['ComunidadE'] != "" ? mayuscula($alu['ComunidadE']) : mayuscula("EL ALTO"); ?>" /></td>
                </tr>
                <tr>
            ...
            <table class="table table-hover table-striped">
                ...
                <tr>
                    ...
                    <td><select name="lenguaMaterna" class="span12">
                            <option value="CASTELLANO" <?php $alu['LenguaMater'] == "CASTELLANO" ? 'selected="selected"' : ''; ?>>CASTELLANO</option>
                            <option value="AYMARA" <?php $alu['LenguaMater'] == "AYMARA" ? 'selected="selected"' : ''; ?>>AYMARA</option>
                            <option value="INGLES" <?php $alu['LenguaMater'] == "INGLES" ? 'selected="selected"' : ''; ?>>INGLES</option>
                        </select></td>
                </tr>
                <tr class="contenido">
                        ...
                        <table>
                            <tr>
                                ...
                                <td><select name="lenguaCastellano" class="span12">
                                        <option value="1" <?php $alu['CastellanoI'] == "1" ? 'selected="selected"' : ''; ?>><?php echo $idioma['Si']; ?></option>
                                        <option value="0" <?php $alu['CastellanoI'] == "0" ? 'selected="selected"' : ''; ?>><?php echo $idioma['No']; ?></option>
                                    </select></td>
                            </tr>
        ...
        <div class="box-content">
            <table class="table table-hover table-striped">
                ...
                <tr>
                    ...
                    <td>::</td>
                    <td><input type="text" name="idiomaP" value="<?php echo mayuscula($alu['IdiomaP']); ?>" /></td>
                </tr>
                <tr>
        ...
        <div class="box-content">
            <table class="table table-hover table-striped">
                ...
                <tr>
                    <td><?php echo $idioma['IdiomaHablaFrecuencia'] ?></td>
                    <td>::</td>
                    <td><input type="text" name="idiomaM" value="<?php echo mayuscula($alu['IdiomaM']); ?>" /></td>
                </tr>
                <tr>
        ...
        <div class="box-content">
            <table class="table table-hover table-striped">
                ...
                <tr>
                    ...
                    <td>::</td>
                    <td>
                        <textarea name="ObservacionesDoc" rows="5" cols="30"><?php echo $doc['Observaciones']; ?></textarea>
                    </td>
                </tr>
                <tr>
