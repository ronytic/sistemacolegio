        ...
        <form action="guardaradmin.php" method="post" enctype="multipart/form-data" id="datos" autocomplete="off">
            <table class="table table-hover table-striped table-bordered">
                <tr>
                    ...
                    <td><?php campo("Nombres", "text", $usuconf['Nombres'], "span6", 1) ?></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['Paterno'] ?>:</td>
                    <td><?php campo("Paterno", "text", $usuconf['Paterno'], "span6", 1) ?></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['Materno'] ?>:</td>
                    <td><?php campo("Materno", "text", $usuconf['Materno'], "span6") ?></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['SobreNombre'] ?>:</td>
                    <td><?php campo("Nick", "text", $usuconf['Nick'], "span6", 1) ?></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['Usuario'] ?>:</td>
                    <td><?php campo("Usuario", "text", $usuconf['Usuario'], "span6", 1) ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php campo("Idioma", "select", $valoridioma, "span6", 1, "", 0, "", $usuconf['Idioma']) ?></td>
                </tr>
                <tr>
                    <td><?php echo $idioma['Foto'] ?>:
                    ...
                    <td><?php campo("Foto", "file", "", "span12", 0, "", 0, array("accept" => "image/*")) ?>
