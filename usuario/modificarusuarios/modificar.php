		...
		<table class="table table-bordered table-striped">
			<tr>
				<td><?php echo $idioma['Paterno'] ?><br>
					<input type="text" value="<?php echo $usua['Paterno'] ?>" name="Paterno" class="span12" placeholder="">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['Materno'] ?><br>
					<input type="text" value="<?php echo $usua['Materno'] ?>" name="Materno" class="span12" placeholder="">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['Nombres'] ?><br>
					<input type="text" value="<?php echo $usua['Nombres'] ?>" name="Nombres" class="span12" placeholder="">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td><?php echo $idioma['Usuario'] ?><br>
					<input type="text" value="<?php echo $usua['Usuario'] ?>" name="Usuario" class="span12" placeholder="">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['Contrasena'] ?><br>
					<input type="text" value="" name="Pass" class="span12" placeholder="" id="Pass">
					<small><?php echo $idioma['NotaContrasena'] ?></small>
					<?php htmlListadoCriteriosContrasena(); ?>
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['Apodo'] ?><br>
					<input type="text" value="<?php echo $usua['Nick'] ?>" name="Nick" class="span12" placeholder="">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['Ci'] ?><br>
					<input type="text" value="<?php echo $usua['Ci'] ?>" name="Ci" class="span12" placeholder="">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['Direccion'] ?><br>
					<input type="text" value="<?php echo $usua['Direccion'] ?>" name="Direccion" class="span12" placeholder="">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['Telefono'] ?><br>
					<input type="text" value="<?php echo $usua['Telefono'] ?>" name="Telefono" class="span12" placeholder="">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['Celular'] ?><br>
					<input type="text" value="<?php echo $usua['Celular'] ?>" name="Celular" class="span12" placeholder="">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['Observacion'] ?><br>
					<input type="text" value="<?php echo $usua['Observacion'] ?>" name="Observacion" class="span12" placeholder="">
				</td>
			</tr>
			<tr>
