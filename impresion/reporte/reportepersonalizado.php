...
class PDF extends PPDF
{
	function Cabecera()
	{
		...
		if (!$Blanco) {
			$this->TituloCabecera(35, isset($idioma[$Campo1]) ? $idioma[$Campo1] : '', "10", $Borde);
			$this->TituloCabecera(35, isset($idioma[$Campo2]) ? $idioma[$Campo2] : '', "10", $Borde);
			$this->TituloCabecera(35, isset($idioma[$Campo3]) ? $idioma[$Campo3] : '', "10", $Borde);
			$this->TituloCabecera(35, isset($idioma[$Campo4]) ? $idioma[$Campo4] : '', "10", $Borde);
		} else {
			switch ($Cantidad) {
				case "1": {
						$this->TituloCabecera(140, "", "10", $Borde);
					}
					break;
				case "2": {
						$this->TituloCabecera(70, "", "10", $Borde);
						$this->TituloCabecera(70, "", "10", $Borde);
					}
					break;
				case "3": {
						...
						$this->TituloCabecera(47, "", "10", $Borde);
						$this->TituloCabecera(46, "", "10", $Borde);
					}
					break;
				case "4": {
...
foreach ($alumno->mostrarAlumnosCurso($CodCurso, $Sexo) as $al) {
	...
	if (!$Blanco) {
		...
		switch ($Cantidad) {
			case "1": {
					$pdf->CuadroCuerpo(140, "", $Somb, "", 1);
				}
				break;
			case "2": {
					$pdf->CuadroCuerpo(70, "", $Somb, "", 1);
					$pdf->CuadroCuerpo(70, "", $Somb, "", 1);
				}
				break;
			case "3": {
