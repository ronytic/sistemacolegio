...
if (!empty($_GET) && $_GET['lock'] == md5('lock')) {
	...
	switch ($Desde) {
		...
		case 3: {
			...
			break;
		case 4: {
				$DesdeT = $idioma["Cuarta"];
			}
			break;
		case 5: {
				$DesdeT = $idioma["Quinta"];
			}
			break;
		case 6: {
				$DesdeT = $idioma["Sexta"];
			...
			break;
		case 7: {
				$DesdeT = $idioma["Septima"];
			}
			break;
		case 8: {
				$DesdeT = $idioma["Octava"];
			}
			break;
		case 9: {
				$DesdeT = $idioma["Novena"];
			}
			break;
		case 10: {
				$DesdeT = $idioma["Decima"];
			}
			break;
	}

	$CursoTexto = $curso->mostrarCurso($CodCurso);
	$CursoTexto = array_shift($CursoTexto);
