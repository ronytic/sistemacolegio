...
if (isset($_POST)) {
    ...
    $Botones = isset($_POST['Botones']) ? $_POST['Botones'] : "1";
    ...
    <table class="table table-bordered table-striped table-hover">
        <thead>
            <tr>
                ...
                <?php if (($Botones == "1")) { ?><th width="60"></th><?php } ?>
            </tr>
        </thead>
    ...
    <?php
            ...
            foreach ($actividades as $ac) {
                ...
                switch ($ac['Prioridad']) {
                    case -1: {
                            $msgpri = "warning";
                            $textoprioridad = $idioma['Bajo'];
                        }
                        break;
                    case 0: {
                            $msgpri = "success";
                            $textoprioridad = $idioma['Normal'];
                        }
                        break;
                    case 1: {
                            $msgpri = "important";
                            $textoprioridad = $idioma['Importante'];
                        }
                        break;
                }
    ?>
        <tr class="<?php echo $acEstado ? 'completado' : '' ?>">
            ...
            ?><td>
                    ...
                    <button class="btn btn-mini" id="eliminar" rel="<?php echo $ac['CodAgendaActividades'] ?>" title="<?php echo $idioma['Eliminar'] ?>"><i class="icon-remove"></i></button>
                </td><?php } else { ?>
                <td></td>
            <?php } ?>
        </tr>
