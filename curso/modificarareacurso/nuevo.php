		...
		<table class="table table-bordered table-striped">
			<tr>
				<td><?php echo $idioma['Nombre'] ?><br>
					<input type="text" value="<?php echo $cur['Nombre'] ?>" name="Nombre" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['Abreviado'] ?><br>
					<input type="text" value="<?php echo $cur['Abreviado'] ?>" name="Abreviado" class="span12">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td><?php echo $idioma['HoraEntradaLunes'] ?><br>
					<input type="time" value="<?php echo $cur['HoraInicioL'] ?>" name="HoraInicioL" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraLimiteEsperaLunes'] ?><br>
					<input type="time" value="<?php echo $cur['HoraEsperaL'] ?>" name="HoraEsperaL" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraEntradaMartes'] ?><br>
					<input type="time" value="<?php echo $cur['HoraInicioM'] ?>" name="HoraInicioM" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraLimiteEsperaMartes'] ?><br>
					<input type="time" value="<?php echo $cur['HoraEsperaM'] ?>" name="HoraEsperaM" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraEntradaMiercoles'] ?><br>
					<input type="time" value="<?php echo $cur['HoraInicioMi'] ?>" name="HoraInicioMi" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraLimiteEsperaMiercoles'] ?><br>
					<input type="time" value="<?php echo $cur['HoraEsperaMi'] ?>" name="HoraEsperaMi" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraEntradaJueves'] ?><br>
					<input type="time" value="<?php echo $cur['HoraInicioJ'] ?>" name="HoraInicioJ" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraLimiteEsperaJueves'] ?><br>
					<input type="time" value="<?php echo $cur['HoraEsperaJ'] ?>" name="HoraEsperaJ" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraEntradaViernes'] ?><br>
					<input type="time" value="<?php echo $cur['HoraInicioV'] ?>" name="HoraInicioV" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraLimiteEsperaViernes'] ?><br>
					<input type="time" value="<?php echo $cur['HoraEsperaV'] ?>" name="HoraEsperaV" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraEntradaSabado'] ?><br>
					<input type="time" value="<?php echo $cur['HoraInicioS'] ?>" name="HoraInicioS" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraLimiteEsperaSabado'] ?><br>
					<input type="time" value="<?php echo $cur['HoraEsperaS'] ?>" name="HoraEsperaS" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraEntradaDomingo'] ?><br>
					<input type="time" value="<?php echo $cur['HoraInicioD'] ?>" name="HoraInicioD" class="span12">
				</td>
			</tr>
			<tr>
				<td><?php echo $idioma['HoraLimiteEsperaDomingo'] ?><br>
					<input type="time" value="<?php echo $cur['HoraEsperaD'] ?>" name="HoraEsperaD" class="span12">
				</td>
			</tr>
			<tr>
