        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                <td><?php echo $idioma['NotaTope'] ?><br>
                    <input type="text" value="<?php echo $cur['NotaTope'] ?>" name="NotaTope" class="span12">
                </td>
            </tr>
            <tr>
                <td><?php echo $idioma['NotaAprobacion'] ?><br>
                    <input type="text" value="<?php echo $cur['NotaAprobacion'] ?>" name="NotaAprobacion" class="span12">
                </td>
            </tr>
            <tr>
