    ...
    <table class="table table-bordered table-striped table-hover table-condensed">
        <thead>
            <tr>
                ...
                <th><?php echo sacarTooltip($idioma['Abreviado'], "", "R", 5) ?></th>
                <th><?php echo sacarTooltip($idioma['Bimestre'], "", "R", 3) ?></th>
                <th><?php echo $idioma['Dps'] ?></th>
                <th><?php echo $idioma['NotaTope'] ?></th>
                <th><?php echo sacarTooltip($idioma['NotaAprobacion']) ?></th>
                <th><?php echo sacarTooltip($idioma['MontoCuotaPagar']) ?></th>
                <th><?php echo sacarTooltip($idioma['CantidadEtapas']) ?></th>
                <th></th>
            </tr>
        </thead>
        <?php
