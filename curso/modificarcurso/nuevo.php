        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                <td><?php echo $idioma['Abreviado'] ?><br>
                    <input type="text" value="<?php echo $cur['Abreviado'] ?>" name="Abreviado" class="span12" placeholder="1 Prim">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><?php echo $idioma['NotaTope'] ?><br>
                    <input type="text" value="<?php echo $cur['NotaTope'] ?>" name="NotaTope" class="span12" placeholder="60">
                </td>
            </tr>
            <tr>
                <td><?php echo $idioma['NotaAprobacion'] ?><br>
                    <input type="text" value="<?php echo $cur['NotaAprobacion'] ?>" name="NotaAprobacion" class="span12" placeholder="36">
                </td>
            </tr>
            <tr>
