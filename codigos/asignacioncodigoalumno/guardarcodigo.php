...
?>
		<div class="alert alert-success">
			...
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
						<th><?php echo $idioma['DatosAlumno'] ?></th>
					</tr>
				</thead>
				<tr>
					<td class="x2"><?php echo capitalizar($al['Paterno'] . " " . $al['Materno'] . " " . $al['Nombres']) ?></td>
				</tr>
				<tr>
					<td class="x2"><?php echo $idioma['CodigoBarra'] ?>: <?php echo $CodBarra ?></td>
				</tr>
			</table>
		</div>
	<?php
