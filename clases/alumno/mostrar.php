...
?>
	...
	<table class="table table-striped table-hover table-bordered">
		<thead>
			<tr>
				<th colspan="2"><?php echo $idioma['Curso'] ?>: <?php echo $cur['Nombre'] ?></th>
				<th colspan="2"><?php echo $idioma['Materia'] ?>: <?php echo $mat['Nombre'] ?></th>
			</tr>
			<tr>
				<th>N</th>
				<th><?php echo $idioma['Comentario'] ?></th>
				<th><?php echo $idioma['Archivos'] ?></th>
				<th></th>
			</tr>
		</thead>
		<?php if (count($cl)) { ?>
			...
			?>
			<tr>
				<td colspan="3"><?php echo $idioma['NoExistenArchivosGuardados'] ?></td>
			</tr>
		<?php }
		?>
	</table>
