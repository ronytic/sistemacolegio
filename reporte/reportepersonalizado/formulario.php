    ...
    <form action="" id="formulario">
        <table class="table table-hover">
            <tr>
                ...
                <td><select name="sexo" class="span12">
            ...
            <tr>
                <td><?php echo $idioma['Columna1'] ?></td>
                <td><select name="campo1" class="input-medium span12">
            ...
            <tr>
                <td><?php echo $idioma['Columna2'] ?></td>
                <td><select name="campo2" class="input-medium span12">
                        <option value=""><?php echo $idioma['Ninguno'] ?></option>
                        <optgroup label="<?php echo $idioma['DatosAlumno'] ?>">
                            <option value="FechaNac"><?php echo $idioma['FechaNacimiento'] ?></option>
                            <option value="Ci"><?php echo $idioma['Ci'] ?></option>
            ...
            <tr>
                <td><?php echo $idioma['Columna3'] ?></td>
                <td><select name="campo3" class="input-medium span12">
                        <option value=""><?php echo $idioma['Ninguno'] ?></option>
                        <optgroup label="<?php echo $idioma['DatosAlumno'] ?>">
                            <option value="FechaNac"><?php echo $idioma['FechaNacimiento'] ?></option>
                            <option value="Ci"><?php echo $idioma['Ci'] ?></option>
            ...
            <tr>
                <td><?php echo $idioma['Columna4'] ?></td>
                <td><select name="campo4" class="input-medium span12">
                        <option value=""><?php echo $idioma['Ninguno'] ?></option>
                        <optgroup label="<?php echo $idioma['DatosAlumno'] ?>">
                            <option value="FechaNac"><?php echo $idioma['FechaNacimiento'] ?></option>
                            <option value="Ci"><?php echo $idioma['Ci'] ?></option>
            ...
            <tr>
                <td><?php echo $idioma['DibujarBorde'] ?></td>
                <td><input type="checkbox" name="borde" /></td>
            </tr>
            <tr>
                <td><?php echo $idioma['DibujarSombreado'] ?></td>
                <td><input type="checkbox" name="sombreado" checked="checked" /></td>
            </tr>
            <tr>
                <td><?php echo $idioma['SoloCasillasBlanco'] ?></td>
                <td><input type="checkbox" name="blanco" />
            ...
            <tr>
                <td></td>
                <td><input type="submit" value="<?php echo $idioma['VerReporte'] ?>" class="btn btn-success" /> </td>
            </tr>
        </table>
    </form>
<?php
